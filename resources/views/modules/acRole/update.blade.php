    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body">
                    <form action="{{ route('access-control.role-save', $role->id) }}" method="POST">
                        @csrf
                                                ...
                                                @foreach($chunk as $permission)
                                                    ...
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="permission_{{ $permission->id }}" name="permissions[]" value="{{ $permission->id }}" {{ in_array($permission->id, $rolePermissions) ? 'checked' : '' }}>
